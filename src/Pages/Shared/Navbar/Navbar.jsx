      ...
      <div className="container mx-auto navbar bg-blue-700 text-white">
        ...
        <div className="navbar-end">
          ...
          {user ? (
            <>
              <div className="flex items-center gap-5">
                <div className="flex items-center">
                  <div className="avatar hidden lg:block online">
            ...
            <>
              <Link to="/login">
                <button className="btn bg-custom-gradient mr-3">LogIn</button>
              </Link>
              <Link to="/signup">
                <button className="btn bg-custom-gradient">SignUp</button>
              </Link>
            </>
          )}
        </div>
