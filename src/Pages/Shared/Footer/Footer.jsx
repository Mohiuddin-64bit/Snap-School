...
const Footer = () => {
  return (
    <>
      {/* <footer className="footer p-10 container bg-blue-700 mx-auto text-neutral-content">
        <div className="">
          <h2 className="text-3xl font-bold mb-5">Snap School</h2>
          <p>
            SnapSchool Industries Ltd.
            <br />
      ...
      <div className=" container mx-auto bg-blue-700  items-center p-4    text-neutral-content">
